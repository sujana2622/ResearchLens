...
2.  Create a Node.js web service on your preferred hosting platform.
...
5.  Add the required environment variables in the hosting platform.
6.  Deploy the application.
7.  Open the generated public URL and test the application.
